...
leftInputPath[2]    = folder .. "testInput/inputImagesLeft2.txt";
leftInputPath[3]    = folder .. "testInput/inputImagesLeft3.txt";
rightInputPath       = {};
rightInputPath[0]    = folder .. "testInput/inputImagesRight0.txt";
rightInputPath[1]    = folder .. "testInput/inputImagesRight1.txt";
rightInputPath[2]    = folder .. "testInput/inputImagesRight2.txt";
rightInputPath[3]    = folder .. "testInput/inputImagesRight3.txt";
inputPath = {
	Left = leftInputPath;
...
------------------ Connections -----------------	
	...
	pvParameters["V1To" .. side[s] .."ErrorAxis" .. i] = {
		groupType = "MomentumConn";
		    ...
		    delay                               = {0.000000};
		    numAxonalArbors                     = 1;
		    plasticityFlag                      = false; -- Disable Learning for Testing
		    convertRateToSpikeCount             = false;
		    receiveGpu                          = false;
		    sharedWeights                       = true;
		    weightInitType                      = "FileWeight";
		    initWeightsFile                     = weightsFolder .. "V1To" .. side[s] .. "ErrorAxis" .. i .. "_W.pvp";
		    sparseFraction                      = 0.9;
