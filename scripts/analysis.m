...
close all;
%setenv('GNUTERM','X11')
addpath('/home/neuralnetlab/workspace/OpenPV/mlab/util/');

workspace_path = '/home/neuralnetlab/workspace/OpenPV/OpenPV/';
output_dir = '../output/';
...
if analyze_Recon_flag
   Input_list = ...
   {['LeftImageAxis0'],['LeftImageAxis1'],['LeftImageAxis2'],['LeftImageAxis3'],['RightImageAxis0'],['RightImageAxis1'],['RightImageAxis2'],['RightImageAxis3'];};
   Recon_list = ...
   {['LeftReconAxis0'],['LeftReconAxis1'],['LeftReconAxis2'],['LeftReconAxis3'],['RightReconAxis0'],['RightReconAxis1'],['RightReconAxis2'],['RightReconAxis3'];};
...
if plot_weights
   weights_list = ...
   {['V1ToLeftErrorAxis0_W'],['V1ToLeftErrorAxis1_W'],['V1ToLeftErrorAxis2_W'],['V1ToLeftErrorAxis3_W'],['V1ToRightErrorAxis0_W'],['V1ToRightErrorAxis1_W'],['V1ToRightErrorAxis2_W'],['V1ToRightErrorAxis3_W']};
   pre_list = ...
   { ...
   ['V1_A'],['V1_A'],['V1_A'],['V1_A'],['V1_A'],['V1_A'],['V1_A'],['V1_A']; ...
   };
   sparse_ndx = ...
   [   ...
   1,1,1,1,1,1,1,1;  ...
   ...
   num_weights_list = size(weights_list,2);
   weights_hdr = cell(num_weights_list,2);
   pre_hdr = cell(num_weights_list,2);
   ...
   for i_weights = 1 : num_weights_list
      ...
      for i_checkpoint = 1 : num_checkpoints
         ...
         weights_file = [checkpoint_path, filesep, weights_list{1,i_weights}, '.pvp'];
      ...
      for i_checkpoint = 1 : num_checkpoints
         ...
         weights_name =  [weights_list{1,i_weights}, '_', num2str(weight_time, '%08d')];
         ...
         if plot_flag && i_checkpoint == max_checkpoint
            ...
            ['Hist_',  weights_list{1,i_weights}, '_', num2str(weight_time, '%08d')]);
